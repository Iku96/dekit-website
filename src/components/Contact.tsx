        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-start">
          ...
          >
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <button
                type="submit"
                className="w-full inline-flex items-center justify-center gap-2 bg-blue-600 text-white px-6 py-4 rounded-xl font-medium hover:bg-blue-700 transition-colors shadow-lg shadow-blue-600/20"
              >
                Send Message
